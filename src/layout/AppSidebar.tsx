...
const othersItems: NavItem[] = [
    {
        ...
        subItems: [
            ...
            {name: "Retard range", path: "/bar-chart-delay-range", pro: false},
            {name: "Progression", path: "/bar-chart-progression", pro: false},
            {name: "Fréquence Récente", path: "/bar-chart-recent-frequency", pro: false},
                    ...
                    {isExpanded || isHovered || isMobileOpen ? (
                        <>
                            <img
                                ...
                                src="/images/logo/Logo_EuroMillions.png"
                                alt="Logo"
                                width={250}
                                height={40}
                            />
