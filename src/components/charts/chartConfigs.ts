...
export const CHARTS: ChartConfig[] = [
  ...
  {
    id: "ecarts",
    path: "/bar-chart-ecarts",
    endpoint: "chart-ecarts",
    dataKey: "ecart_reduc",
    xAxisTitle: "Écarts",
    scope: "numbers",
    metaTitle: "Ecarts",
    metaDescription: "Ecarts Chart",
    breadcrumb: "Ecarts",
    cardTitle: "Bar Chart Ecarts",
    top10Title: "Top 10 des écarts",
    top10Label: "Écart",
    top10Uppercase: true,
  },
  {
    id: "ecarts-range",
    path: "/bar-chart-ecarts-range",
    endpoint: "chart-ecarts-range",
    dataKey: "ecart_range",
    xAxisTitle: "Tranches d'écarts",
    scope: "numbers",
    mode: "direct",
    metaTitle: "Ecarts Range",
    metaDescription: "Ecarts Range Chart",
    breadcrumb: "Ecarts Range",
    cardTitle: "Bar Chart Ecarts Range",
    top10Title: "Top 10 des combinaisons d'écarts",
    top10Label: "Combinaison",
    top10Uppercase: true,
    top10Monospace: true,
    top10Truncate: true,
