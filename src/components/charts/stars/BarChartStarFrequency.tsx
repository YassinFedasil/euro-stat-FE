...
type BarChartStarFrequencyProps = {
    onTop10Change?: (top10: [string, number][]) => void;
};

export default function BarChartStarFrequency({ onTop10Change }: BarChartStarFrequencyProps) {
    ...
    useEffect(() => { fetchFrequency(lastDraws); }, [lastDraws]);
