...
type BarChartStarFrequencyPreviousPeriodProps = {
    onTop10Change?: (top10: [string, number][]) => void;
};

export default function BarChartStarFrequencyPreviousPeriod({ onTop10Change }: BarChartStarFrequencyPreviousPeriodProps) {
    ...
    const options: ApexOptions = {
        ...
        xaxis: { categories, title: { text: "Fréq. Période Préc" } },
