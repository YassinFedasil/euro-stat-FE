...
const StarsStat: React.FC = () => {
    ...
    return (
        <div style={{ padding: 16 }}>
            <h2 style={{ marginBottom: 12 }}>Stars – Import/Cache</h2>
            ...
            {data && (
                <>
                    <div style={{ marginBottom: 8 }}>
                        <strong>Tirage:</strong> {data._id} — <em>{data.stars.length} lignes</em>
                    </div>
                    <div style={{ overflowX: "auto" }}>
                        <table style={{ borderCollapse: "collapse", width: "100%", minWidth: 820 }}>
                            ...
                            {data.stars.map((row) => (
                                <tr key={row.star}>
                                    <td style={{ padding: "6px 8px" }}>{row.star}</td>
