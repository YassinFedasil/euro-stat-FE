        ...
        <div>
            ...
            <div className="space-y-6">
                <ComponentCard title="Bar Chart Progression">
                    <BarChartStarProgression onTop10Change={setTop10} />
                </ComponentCard>

                {top10.length > 0 && (
                    <ComponentCard title="Top 10 Progressions">
                        <div className="overflow-x-auto">
                            <table className="mx-auto table-auto border border-gray-200 rounded-lg divide-y divide-gray-200">
                                ...
                                {top10.map(([progression, count]) => (
                                    <tr key={progression} className="hover:bg-gray-50 transition">
