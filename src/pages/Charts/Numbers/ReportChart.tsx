...
export default function ReportChart() {
    ...
    return (
        <div>
            <PageMeta
                title="Report"
                description="Report Chart"
            />
            <PageBreadcrumb pageTitle="Report" />

            <div className="space-y-6">
                <ComponentCard title="Bar Chart Report">
                    <BarChartReport onTop10Change={setTop10} />
                </ComponentCard>

                {top10.length > 0 && (
                    <ComponentCard title="Top 10 Rapports">
                        <div className="overflow-x-auto">
                            <table className="mx-auto table-auto border border-gray-200 rounded-lg divide-y divide-gray-200">
                                ...
                                {top10.map(([report, count]) => (
                                    <tr key={report} className="hover:bg-gray-50 transition">
